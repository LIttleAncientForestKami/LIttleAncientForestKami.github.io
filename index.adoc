...
. http://lafk.pl/Prezki/Tools-worth-knowing.html[Tools worth knowing (EN)] for 4Dev 2021 
. http://lafk.pl/Prezki/MongoDB-a-sceptic-view.html[MongoDB - a sceptic's view (EN)] for JDD 2021 
